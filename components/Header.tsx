  ...
  return (
    <header className="w-full">
            ...
            <div className="flex-col w-full">
              <div className="flex md:flex-1 justify-between items-center w-full">
                <NavigationMenu>
                  <NavigationMenuList className="flex gap-4 lg:gap-8 text-[10px] font-light">
                    <NavigationMenuItem>
                      <NavigationMenuTrigger className="text-xs font-normal">Tools</NavigationMenuTrigger>
                      <NavigationMenuContent>
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuTrigger className="text-xs font-normal">Outdoor Equipment</NavigationMenuTrigger>
                      <NavigationMenuContent>
                        <div className="w-[800px] p-6">
                          <div className="grid grid-cols-4 gap-8">
                            <div>
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuTrigger className="text-xs font-normal">Building Materials</NavigationMenuTrigger>
                      <NavigationMenuContent>
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuTrigger className="text-xs font-normal">
                        Home Essentials & Decor
                      </NavigationMenuTrigger>
                      <NavigationMenuContent>
                        <div className="w-[800px] p-6">
                ...
                <div className="hidden lg:flex items-center gap-6 ml-6 font-light text-[10px]">
                  ...
                  <Button className="bg-emerald-900 hover:bg-emerald-700 rounded-full font-light text-[10px] cursor-pointer">
                    Contact Us
                  </Button>
                </div>
              </div>
              ...
              <div className="flex flex-col mt-2">
                <NavigationMenu>
                  <NavigationMenuList>
                    <NavigationMenuItem>
                      <NavigationMenuTrigger className="text-xs font-normal">B2B Solutions</NavigationMenuTrigger>
                      <NavigationMenuContent>
                        <div className="w-[600px] p-6">
                          <div className="grid grid-cols-2 gap-8">
                            <div>
                              <h3 className="font-semibold text-xs text-gray-900 mb-3">Bulk Orders</h3>
                              <div className="space-y-2">
                                <Link href="/b2b" className="block text-[10px] text-gray-600 hover:text-red-600">
                            ...
                            <div>
                              <h3 className="font-semibold text-xs text-gray-900 mb-3">Services</h3>
                              <div className="space-y-2">
                                <Link href="/b2b" className="block text-[10px] text-gray-600 hover:text-red-600">
                                  Custom Quotes
                                </Link>
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuLink asChild>
                        <Link href="/top-sellers" className="text-xs font-light hover:text-red-600">
                          Top Sellers
                        </Link>
                      </NavigationMenuLink>
                    </NavigationMenuItem>
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuLink asChild>
                        <Link href="/fresh-stock" className="text-xs font-light hover:text-red-600">
                          Just In: Fresh Stock
                        </Link>
                      </NavigationMenuLink>
                    </NavigationMenuItem>
      ...
      <div className="bg-emerald-900 text-white py-2">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center lg:justify-between text-[10px] sm:text-xs w-full">
            <div className="flex items-center gap-8 text-[10px] sm:gap-6 lg:gap-12 justify-between w-full">
