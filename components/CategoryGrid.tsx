          ...
          <div className="lg:row-span-2 relative group overflow-hidden rounded-lg cursor-pointer">
            <Link href={categoryCards[0].href}>
              ...
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-white">
                  <h3 className="text-lg sm:text-xl font-bold mb-1">{categoryCards[0].title}</h3>
                  <p className="text-xs sm:text-sm mb-2 sm:mb-3 hover:underline">{categoryCards[0].subtitle}</p>
              </div>
            </Link>
          </div>
            ...
            <div key={card.id} className="relative group overflow-hidden rounded-lg cursor-pointer">
              <Link href={card.href}>
                ...
                <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-white">
                  ...
                  <p className="text-xs sm:text-sm mb-2 sm:mb-3 hover:underline">{card.subtitle}</p>
                </div>
              </Link>
            </div>
          ))}
